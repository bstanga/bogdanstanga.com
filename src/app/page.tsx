...
import { posts, getYear, formatDate } from "@/data/posts";
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(generateBlogJsonLd(posts)),
        }}
      />
        ...
        <section className="space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed tracking-wide">
              ...
              , building, scaling and operating high-impact teams that ship
              features at speed.
              <br />
              <br />
              Also building{" "}
